      ...
      <nav>
        <div class="logo">
          <a href="<?php echo esc_url(home_url('/')); ?>">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/i4ware-software.png"
              alt="i4ware Software Logo" />
          </a>
        </div>
  ...
  <?php if (is_front_page()): ?>
    ...
    <section class="hero">
      <div class="container hero-content">
        ...
        <a href="<?php echo esc_url(get_theme_mod('hero_button_link', 'https://marketplace.atlassian.com/search?query=i4ware')); ?>"
