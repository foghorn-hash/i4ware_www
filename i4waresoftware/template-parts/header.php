...
<head>
    ...
    <?php
    $i4ware_head_scripts = get_theme_mod( 'i4ware_head_scripts', '' );
    if ( ! empty( $i4ware_head_scripts ) ) {
        echo $i4ware_head_scripts; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
    }
    ?>
