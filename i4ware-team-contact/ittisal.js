    ...
    $('#contact-form').on('submit', function(e){
        ...
        if (typeof grecaptcha !== 'undefined' && $form.find('.g-recaptcha').length) {
            ...
            if (!recaptchaResponse) {
                $form.find('.contact-response').text(i4ware_ajax.recaptcha_msg || 'يرجى إثبات أنك لست روبوتًا (reCAPTCHA).');
                return;
            }
        }
        ...
        $form.find('.contact-response').text(i4ware_ajax.sending_msg || 'جاري الإرسال...');
